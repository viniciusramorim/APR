const questions_indoor = [{
    ...
    'Segurança Estrutural Indoor':[{
        ...
        question: 'Porta de acesso aos equipamentos, é dotada de sistema tipo Boca de Lobo com fechadura ou cadeado Bluetooth?',
        answers: ["Sim", "Não"],
        textarea: true,
        selectOptions: true,
        inputImages: true,
        ...
        question: 'Os gabinetes são providos de proteção antifurto/vandalismo? Descrever no campo comentários?',
        answers: ["Sim", "Não"],
        textarea: true,
        selectOptions: true,
        inputImages: true,
